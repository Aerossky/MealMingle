...
<body class="flex flex-col min-h-screen font-sahabatLariku ">
            ...
            <div class="flex items-center flex-col md:flex-row">
                ...
                <div class="md:w-2/3 order-2 md:order-1">
                    ...
                    <div class=" flex justify-center md:justify-start">
                        <button type="button" class="mt-[30px] text-white bg-merahMM hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 me-2 mb-2">Pesan</button>
                    </div>
                </div>
    ...
    {{-- about section --}}
    <section class="bg-merahMM mt-[-190px] md:mt-[-65px] text-center" id="about">
        ...
        <div class="px-4 md:mx-24">
            ...
            <div class="flex items-center flex-col md:flex-row">
                ...
                <div class="w-full md:w-1/3">
                    ...
                    <div class="flex justify-center md:justify-start">
                        <button type="button" class="mt-[30px] text-black bg-kuningMM hover:bg-yellow-400 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-8 py-2.5 me-2 mb-2">Pesan</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="flex flex-col justify-center mt-20 bg-kuningMM p-3" id="testimoni">
        <div class="px-4 md:mx-24">
            ...
            <figure class="max-w-screen-md mx-auto text-center mt-5">
                <svg class="w-10 h-10 mx-auto mb-3 text-black dark:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 14">
                    ...
                    <div class="max-w-3xl mx-auto divide-y-2 divide-gray-200">
                        ...
                        <dl class="mt-6 space-y-6 divide-y divide-gray-200">
                            <div x-data="{ open: false }">
                                <dt class="text-lg">
                                    <button type="button" @click="open = !open" aria-controls="faq-1" :aria-expanded="open.toString()" class="text-left w-full flex justify-between items-start text-gray-400">
                                ...
                                <dd class="mt-2 pr-12" id="faq-1" x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 transform scale-100" x-transition:leave-end="opacity-0 transform scale-95">
