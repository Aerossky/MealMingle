...
@section('title', 'Universitas Edit Admin')

@section('content')

    <div class="flex items-center justify-between">
        <h1 class="font-bold text-2xl py-5">Edit Universitas</h1>
        <div class="">
    ...
    <div class="p-4 bg-white border shadow-md min-h-40 rounded-lg overflow-x-auto">
        <form action="{{ route('universitas.update', $universitas->id) }}" method="post" method="POST">
            @csrf
            @method('put')
