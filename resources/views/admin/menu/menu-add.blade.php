...
@section('content')
    ...
    <div class="p-4 bg-white border shadow-md min-h-40 rounded-lg overflow-x-auto">
        <form action="{{ route('menu.store-menu', $tenantId) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="mb-4 col-span-1">
                    ...
                    <input type="number" id="harga_produk" name="harga_produk" class="mt-1 p-2 w-full border rounded-md"
                        required>
                </div>
