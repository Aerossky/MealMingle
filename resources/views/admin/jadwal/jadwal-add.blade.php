...
@section('title', 'Jadwak Add')

@section('content')

    <div class="flex items-center justify-between">
        <h1 class="font-bold text-2xl py-5">Tambah Jadwal</h1>
        <div class="">
        ...
        <form action="{{ route('jadwal.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="mb-4 col-span-2">
                    ...
                    <input type="text" id="hari" name="hari" class="mt-1 p-2 w-full border rounded-md">
                </div>

                <!-- Waktu -->
                <div class="mb-4 col-span-2">
                    <label for="waktu" class="block text-sm font-medium text-gray-600">Waktu</label>
                    <input type="time" id="waktu" name="waktu" class="mt-1 p-2 w-full border rounded-md">
                </div>
